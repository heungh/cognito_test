...
# - Lambda 함수 2개 생성 및 배포
#   1) PostConfirmation: 가입 후 내부/외부 사용자 자동 판별, 그룹 할당
#   2) PreTokenGeneration: 토큰에 커스텀 클레임 추가
...
# ---------------------------------------------
# Lambda 함수 1: Post Confirmation
# ---------------------------------------------
echo ""
echo "2. Creating ${POST_CONFIRMATION_FUNCTION} Lambda..."
...
# ---------------------------------------------
# Lambda 함수 2: Pre Token Generation
# ---------------------------------------------
echo ""
echo "3. Creating ${PRE_TOKEN_GEN_FUNCTION} Lambda..."
...
# ---------------------------------------------
echo ""
echo "4. Connecting Lambda Triggers to User Pool..."
...
# zip 파일 정리
rm -f post_confirmation.zip pre_token_generation.zip
...
echo "=========================================="
echo ""
echo "| Trigger               | Lambda Function                | 기능                          |"
echo "|-----------------------|--------------------------------|-------------------------------|"
echo "| Post Confirmation     | ${POST_CONFIRMATION_FUNCTION}  | 내부/외부 사용자 자동 판별    |"
echo "| Pre Token Generation  | ${PRE_TOKEN_GEN_FUNCTION}      | 토큰에 커스텀 클레임 추가     |"
echo ""
